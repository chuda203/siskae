<template>
    ...
    <div class="container">
      ...
      <div v-if="showModal" class="modal-overlay" @click="closeModal">
        <div class="modal-content" @click.stop>
          ...
          <button v-if="!selectedMahasiswa.diterima" class="terima-button" @click="terimaMahasiswa(selectedMahasiswa)">Terima</button>
  ...
  export default {
        ...
        mahasiswaList: [
          {
            ...
            diterima: false,
            mataKuliah: [
              { kode: 'IF101', nama: 'Pemrograman Dasar', sks: 3, namaDosen: 'Dr. John Doe', semester: 1 },
              { kode: 'IF102', nama: 'Struktur Data', sks: 3, namaDosen: 'Dr. Jane Smith', semester: 2 },
              { kode: 'IF201', nama: 'Algoritma dan Pemrograman', sks: 4, namaDosen: 'Prof. Alice Brown', semester: 3 },
              { kode: 'IF202', nama: 'Basis Data', sks: 4, namaDosen: 'Prof. Bob White', semester: 4 },
              { kode: 'IF203', nama: 'Pemrograman Lanjut', sks: 4, namaDosen: 'Dr. Chris Black', semester: 5 },
            ]
          },
          {
            nama: 'Jane Smith',
    ...
    computed: {
      filteredMahasiswa() {
        return this.mahasiswaList.filter(mhs => {
          ...
          if (this.filter === 'accepted') return mhs.diterima;
          if (this.filter === 'not_accepted') return !mhs.diterima;
        });
      },
    ...
    methods: {
      ...
      terimaMahasiswa(mahasiswa) {
        mahasiswa.diterima = true;
        this.showModal = false;
      }
    }
  };
